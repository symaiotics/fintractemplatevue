...
let entity = new mongoose.Schema({
    surname: {type: String, required:[true,'Field is mandatory']},
    givenName: {type: String, required:[true,'Field is mandatory']},
    telephoneNumber: {type: Number, required:[true,'Field is mandatory']},
    //Remember to put constraint for dashes and brackets in phone num
    telephoneNumberExt: {type: Number, required:[true,'Invalid format']},
